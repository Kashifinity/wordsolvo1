...
<div class="content-i">
 ...
 <table id="example" style="width: 100%;" class="display table table-bordered table-responsive" style="width:100%">
        ...
        <tbody>                                    <?php
                 ...
                 $qry = mysqli_query($connection, "SELECT * FROM assign_task where emp_id='$emp_id' and status='WIP' order by work_assign_date desc") or die("select query fail" . mysqli_error());
$count = 0;
