...
{               ?>  
    ...
    <div class="menu">
        <ul id="menu" >
            <li><a href="../dashboard.php"><i class="fa fa-tachometer"></i> <span>Daily Sales Report</span></a></li>

            
            <li><a href="../invoices.php"><i class="fa fa-file-text-o"></i> <span>Invoices</span></a></li>
            <li><a href="../attendance/mtest/index.php"><i class="fa fa-file-text-o"></i> <span>Attendance</span></a></li>
            <li><a href="../invoices.php"><i class="fa fa-file-text-o"></i> <span>MIS</span></a></li>

           
            <li><a href="search-invoices.php"><i class="fa fa-search"></i> <span>Upload</span></a></li>
