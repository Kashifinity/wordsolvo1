...
if (!empty($_POST['from_date']) && !empty($_POST['to_date'])) {
    ...
    if($conn->connect_error){
		...
		$stmt = $conn->prepare("SELECT * from image WHERE date BETWEEN ? AND ? "); 
        ...
        echo"    <h5 align='center' style='color:blue'></h5>
          ...
          <tr><th>Date</th><th>Location</th><th>Grooming Images</th></tr>       </tr>
       </thead>
        <tbody>";
            ...
            while($row = $result->fetch_assoc()) {
				...
				echo "<td>
				<img src='../../../storehabsiguda/dailyupload/" . $row["image_path"] . "' alt='Cash Slip Image' width='100'>
				<br>
				<a href='../../../storehabsiguda/dailyupload/" . $row["image_path"] . "' download>Download</a>
			   </td>";
