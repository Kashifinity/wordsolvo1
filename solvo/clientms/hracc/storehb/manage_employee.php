...
<div class="container-fluid">
	<form id='employee_frm' type="multipart/form-data">
		...
		<div class="form-group">
			...
			<input type="number" name="mobile" required="required" class="form-control text-right" step="any" value="<?php echo isset($mobile) ? $mobile : "" ?>" />
		</div>
		<div class="form-group">
			<label>Aadhar Number</label>
			<input type="number" name="aadharno"  required="required" class="form-control text-right" step="any" value="<?php echo isset($aadharno) ? $aadharno : "" ?>" />
		</div>
		<div class="form-group">
			<label>Pan Number</label>
			<input type="number" name="panno" required="required" class="form-control text-right" step="any" value="<?php echo isset($panno) ? $panno : "" ?>" />
		</div>
