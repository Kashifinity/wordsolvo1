...
<link rel="icon" href="img/favicon/favicon_32x32.png" sizes="32x32">
  ...
  <!-- For Windows Phone -->
                    ...
                    <h6 class="element-header">Welcome to Admin Dashboard <?php echo $_SESSION['emp_name'];?></h6>
                    <div class="element-content">
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-xxxl-3">
                                <a class="element-box el-tablo" href="order_list.php">
                            ...
                            <div class="col-sm-4 col-xxxl-3">
                                <a class="element-box el-tablo" href="orders.php">
                            ...
                            <div class="col-sm-4 col-xxxl-3">
                                <a class="element-box el-tablo" href="assign_task_list_close.php">
                                    <div class="label">task ended</div>
                    ...
                    <tr>
                        ...
                        <th>Open</th>                          
                          ...
                          <!--<th>Delete</th>-->
                                                               ...
                                                               <?php
                 $qry = mysqli_query($connection, "SELECT * FROM emp_login where user_role='Customer'") or die("select query fail" . mysqli_error());
$count = 0;
                    ...
                    <tr>
                        ...
                        <th>Open</th>                          
                          ...
                          <!--<th>Delete</th>-->
                                                               ...
                                                               <?php
                 $qry = mysqli_query($connection, "SELECT * FROM emp_login where user_role='manager'") or die("select query fail" . mysqli_error());
$count = 0;
while ($row = mysqli_fetch_assoc($qry)) {
    $count = $count + 1;
                    ...
                    <tr>
                        ...
                        <th>Open</th>                          
                          ...
                          <!--<th>Delete</th>-->
                                                               ...
                                                               <?php
                 $qry = mysqli_query($connection, "SELECT * FROM emp_login where user_role='writer'") or die("select query fail" . mysqli_error());
$count = 0;
while ($row = mysqli_fetch_assoc($qry)) {
    $count = $count + 1;
                    ...
                    <tr>
                        ...
                        <th>Open</th>                          
                          ...
                          <!--<th>Delete</th>-->
                                                               ...
                                                               <?php
                 $qry = mysqli_query($connection, "SELECT * FROM emp_login where user_role='QA'") or die("select query fail" . mysqli_error());
$count = 0;
while ($row = mysqli_fetch_assoc($qry)) {
    $count = $count + 1;
        ...
        <div class="element-wrapper">
            ...
            <div class="element-box-tp">
                <div class="el-buttons-list full-width">
                    ...
                    <a class="btn btn-white btn-sm" href="emp_assign_task.php">
