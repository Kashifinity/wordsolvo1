      <!--------------------
                ...
                <div class="menu-mobile menu-activated-on-click color-scheme-dark">
                    <div class="mm-logo-buttons-w"><a class="mm-logo" href="#"><span>Word Solvo</span></a>
                    ...
                    ?>
                        ...
                        <li class="">
                            <a href="Dashboard.php">
                                <div class="icon-w">
                                    <div class="os-icon os-icon-cart"></div>
                                </div><span>Dashboard</span></a>
                        ...
                        <li class=" has-sub-menu">
                            ...
                            <div class="sub-menu-w">
                                ...
                                <div class="sub-menu-i">
                                    <ul class="sub-menu">
                                        <li><a href="bank_details.php">Bank Details of employee</a></li>
                            ...
                            <div class="sub-menu-w">
                                ...
                                <div class="sub-menu-i">
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="assign_task_open_list.php">Task start</a></li>  
                                        <li><a href="assign_task_list_close.php">Task end</a></li>  
                                        <li><a href="assign_task_list_wip.php">Task in progress</a></li>  
                ...
                <div class="menu-w color-scheme-light color-style-transparent menu-position-side menu-side-left menu-layout-compact sub-menu-style-over sub-menu-color-bright selected-menu-color-light menu-activated-on-hover menu-has-selected-link">
                    <div class="logo-w">
                        <a class="logo" href="#">
                            ...
                            <div class="logo-label">Word Solvo</div>
                        </a>
                    </div>
<!--                      <div class="logged-user-w">
                         ...
                         <li class=" has-sub-menu">
                            ...
                            <div class="sub-menu-w">
                                ...
                                <div class="sub-menu-i">
                                    <ul class="sub-menu">
                                        <li><a href="assign_task.php">Assign Task</a></li>
                                        <li><a href="placeorder.php">Assign Task</a></li>
                                        <li><a href="assign_task_list.php">Task List</a></li>  
