...
<!--                               <th>Edit</th>-->
                 ...
                 $qry = mysqli_query($connection, "SELECT * FROM assign_task where emp_id='$empID' and status='$status' order by work_assign_date desc") or die("select query fail" . mysqli_error());
$count = 0;
while ($row = mysqli_fetch_assoc($qry)) {
  ...
  <td><a href="task_doc/<?php echo $task_doc;?>" class="btn btn-primary">Download</a></td> 
