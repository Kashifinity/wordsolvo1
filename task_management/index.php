         ...
         <h1 class="row"> Welcome to Word Solvo</h1>  
            ...
            <form action="#" method="post" class="form">
                ...
                <div class="form-group">
                    ...
                    <input class="" name="User_nm" placeholder="Enter your username" type="text">
          ...
          <p class="margin medium-small"><a href="index.php">Admin Login</a></p>
            <p class="margin medium-small"><a href="index.php">Manager Login</a></p>
            <p class="margin medium-small"><a href="index.php">QA Login</a></p>
            <p class="margin medium-small"><a href="index.php">Writer Login</a></p>
          </div>         
        </div>
          <div class="buttonn">
